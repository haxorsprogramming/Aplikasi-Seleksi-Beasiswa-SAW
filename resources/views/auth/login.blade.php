        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-center mb-5">
                    <img src="https://nos.jkt-1.neo.id/aditiastorage/asset/logo/almira-tech-circle.png" style="width: 150px;margin-bottom: 10px;">
                    <h5 class="font-size-16 text-white mb-4">Aplikasi Seleksi Penerimaan Beasiswa</h5>
                </div>
            </div>
        </div>
        <!-- end row -->
