...
<head>
    <meta charset="utf-8" />
    <title>Dashboard - Aplikasi Seleksi Penerimaan Beasiswa SAW</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Sistem informasi pembantu sistem seleksi penerimaan beasiswa menggunakan metode SAW" name="description" />
    <meta content="DataScienceProject" name="Almira-Tech" />
    <!-- App favicon -->
        ...
        <div class="container-fluid">
            <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                <div class="collapse navbar-collapse" id="topnav-menu-content">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0)" onclick="renderPage('app/core/beranda', 'Dashboard')">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0)" onclick="renderPage('app/core/assign', 'Assign Peserta Seleksi')">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0)" onclick="renderPage('app/laporan/data', 'Laporan Apriori')">
                                <i class="mdi mdi-file-document-box-search mr-2"></i>Laporan & Statistik
                            </a>
                        </li>
                        <li class="nav-item">
